<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('applicant.jobs.index')" :active="request()->routeIs('applicant.jobs.*')">
                        {{ __('Browse Jobs') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('hr.jobs.index')" :active="request()->routeIs('hr.jobs.*')">
                        {{ __('Manage Jobs') }}
                    </x-nav-link>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                            ...
                            {{-- Show role badge --}}
                            <div class="ms-2 text-xs text-indigo-500 font-semibold capitalize">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('applicant.jobs.index')" :active="request()->routeIs('applicant.jobs.*')">
                {{ __('Browse Jobs') }}
            </x-responsive-nav-link>
            ...
            <x-responsive-nav-link :href="route('hr.jobs.index')" :active="request()->routeIs('hr.jobs.*')">
                {{ __('Manage Jobs') }}
            </x-responsive-nav-link>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                ...
                <div class="font-medium text-xs text-indigo-500 capitalize">{{ str_replace('_', ' ', Auth::user()->role) }}</div>
            </div>
